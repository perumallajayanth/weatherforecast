...
A fully responsive weather forecast application built with HTML, CSS, and vanilla JavaScript that uses the OpenWeatherMap API to display current weather and a 5-day forecast for any city.
